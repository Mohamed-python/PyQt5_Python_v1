...
from PyQt5.QtWidgets import QPushButton,QDialog,QLineEdit,QVBoxLayout ,QMainWindow,QApplication,QLabel ,QGroupBox,QMessageBox,QWidget,QComboBox,QTableWidgetItem,QTableWidget,QTabWidget
...
class Ui(QMainWindow):
    ...
    def test_2(self):
        self.nnn = ""
        self.countdown2 = QTimer()
        self.countdown2.setInterval(1000)  # تحديث العد كل ثانية
        self.countdown2.timeout.connect(self.update_countdown)
